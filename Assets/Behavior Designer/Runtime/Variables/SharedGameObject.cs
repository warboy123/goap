...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedGameObject : SharedVariable
    {
        ...
        public static implicit operator SharedGameObject(GameObject value) { var sharedVariable = ScriptableObject.CreateInstance<SharedGameObject>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
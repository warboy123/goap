...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedGameObjectList : SharedVariable
    {
        ...
        public static implicit operator SharedGameObjectList(List<GameObject> value) { var sharedVariable = ScriptableObject.CreateInstance<SharedGameObjectList>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedColor : SharedVariable
    {
        ...
        public static implicit operator SharedColor(Color value) { var sharedVariable = ScriptableObject.CreateInstance<SharedColor>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedQuaternion : SharedVariable
    {
        ...
        public static implicit operator SharedQuaternion(Quaternion value) { var sharedVariable = ScriptableObject.CreateInstance<SharedQuaternion>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
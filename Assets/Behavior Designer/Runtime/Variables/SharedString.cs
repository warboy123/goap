...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedString : SharedVariable
    {
        ...
        public static implicit operator SharedString(string value) { var sharedVariable = ScriptableObject.CreateInstance<SharedString>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
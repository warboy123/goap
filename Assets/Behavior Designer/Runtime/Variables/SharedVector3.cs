...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedVector3 : SharedVariable
    {
        ...
        public static implicit operator SharedVector3(Vector3 value) { var sharedVariable = ScriptableObject.CreateInstance<SharedVector3>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedObjectList : SharedVariable
    {
        ...
        public static implicit operator SharedObjectList(List<Object> value) { var sharedVariable = ScriptableObject.CreateInstance<SharedObjectList>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
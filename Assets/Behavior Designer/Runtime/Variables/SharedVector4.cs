...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedVector4 : SharedVariable
    {
        ...
        public static implicit operator SharedVector4(Vector4 value) { var sharedVariable = ScriptableObject.CreateInstance<SharedVector4>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
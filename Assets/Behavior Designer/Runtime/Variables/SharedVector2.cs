...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedVector2 : SharedVariable
    {
        ...
        public static implicit operator SharedVector2(Vector2 value) { var sharedVariable = ScriptableObject.CreateInstance<SharedVector2>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
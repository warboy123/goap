...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedTransformList : SharedVariable
    {
        ...
        public static implicit operator SharedTransformList(List<Transform> value) { var sharedVariable = ScriptableObject.CreateInstance<SharedTransformList>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}
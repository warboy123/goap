...
namespace BehaviorDesigner.Runtime
{
    ...
    public class SharedTransform : SharedVariable
    {
        ...
        public static implicit operator SharedTransform(Transform value) { var sharedVariable = ScriptableObject.CreateInstance<SharedTransform>(); sharedVariable.SetValue(value); return sharedVariable; }
    }
}